...
def makeplot():
	...
	h = requests.get('https://www.quandl.com/api/v3/datasets/WIKI/' + ticker + '/data.json?api_key=Qsspq9oLN8EGfAJzg93S&start_date=2015-06-01&end_date=2015-06-30').content
